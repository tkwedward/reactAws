...
import meunLinksData from "./data/menu_link.json"
      ...
      <header id="intro">
        ...
        <nav id="nav">
          <div className="navbar">
            <div className="brand"><a href="#welcome">Rashida <span>Hotel</span></a></div>
            <ul>
              <li>
                <a className="icon info" href="#hotelinfo"><span>info</span></a>
              </li>
              <li>
